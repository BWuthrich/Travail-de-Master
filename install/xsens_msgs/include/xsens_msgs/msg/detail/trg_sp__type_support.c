...
static rosidl_typesupport_introspection_c__MessageMember TrgSP__rosidl_typesupport_introspection_c__TrgSP_message_member_array[2] = {
  {
    "stamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xsens_msgs__msg__TrgSP, trig_counter),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
