...
bool xsens_msgs__msg__trg_sp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xsens_msgs.msg._trg_sp.TrgSP", full_classname_dest, 28) == 0);
  }
  xsens_msgs__msg__TrgSP * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of TrgSP */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("xsens_msgs.msg._trg_sp");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrgSP");
