...
bool xsens_msgs__msg__pos_ins__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xsens_msgs.msg._pos_ins.PosINS", full_classname_dest, 30) == 0);
  }
  xsens_msgs__msg__PosINS * ros_message = _ros_message;
  {  // lon
...
{
  /* NOTE(esteve): Call constructor of PosINS */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("xsens_msgs.msg._pos_ins");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PosINS");
