...
: ${AMENT_CURRENT_PREFIX:="/app/dev_ws/install/bluespace_ai_xsens_mti_driver"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bluespace_ai_xsens_mti_driver/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bluespace_ai_xsens_mti_driver/environment/path.sh"
