    ...
    def parse_MTData2(self, data):
        ...
        def parse_orientation_data(data_id, content, ffmt):
            ...
            if (data_id & 0x00F0) == 0x10:  # Quaternion
                ...
                o['a'], o['b'], o['c'], o['d'], o['e'], o['f'], \
                 o['g'], o['h'], o['i'] = parse_floats(content, ffmt, 9)
        ...
        def parse_GNSS(data_id, content, ffmt):
            ...
            if (data_id & 0x00F0) == 0x10:  # GnssPvtData
                o['itow'], o['year'], o['month'], o['day'], o['hour'],\
                    ...
                    o['fixtype'], o['flags'], o['numSV'], \
                    _, o['lon'], o['lat'], \
                    o['height'], o['hMSL'], o['hAcc'], o['vAcc'], o['velN'], \
                    o['velE'], o['velD'], o['gSpeed'], \
                    o['headMot'], o['sAcc'], \
        ...
        def parse_floats(content, ffmt, nb):
            if ffmt == "Float32":
                ...
                return [f / (2**20)
                        for f in struct.unpack("!"+"i"*nb, content)]
            elif ffmt == "Fp1632":
...
def find_baudrate(port, verbose=False):
    baudrates = (115200, 460800, 921600, 2000000, 3686400, 4000000,
                 230400, 57600, 38400, 19200, 9600)
    for br in baudrates:
        if verbose:
