...
#include "xsens_msgs/msg/detail/pos_pa__rosidl_typesupport_fastrtps_c.h"
...
using _PosPA__ros_msg_type = xsens_msgs__msg__PosPA;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PosPA__ros_msg_type * ros_message = static_cast<const _PosPA__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
  ...
  void * untyped_ros_message)
{
  ...
  _PosPA__ros_msg_type * ros_message = static_cast<_PosPA__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
size_t get_serialized_size_xsens_msgs__msg__PosPA(
  const void * untyped_ros_message,
...
static uint32_t _PosPA__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xsens_msgs__msg__PosPA(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xsens_msgs
size_t max_serialized_size_xsens_msgs__msg__PosPA(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_xsens_msgs__msg__PosPA(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_PosPA = {
  "xsens_msgs::msg",
  "PosPA",
...
static rosidl_message_type_support_t _PosPA__type_support = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xsens_msgs, msg, PosPA)() {
  return &_PosPA__type_support;
}
