...
bool xsens_msgs__msg__config_xsens__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // output_config
    PyObject * field = PyObject_GetAttrString(_pymsg, "output_config");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->output_config, PyBytes_AS_STRING(encoded_field));
  ...
  {  // sync_config
    PyObject * field = PyObject_GetAttrString(_pymsg, "sync_config");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint32_t * dest = ros_message->sync_config.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'sync_config'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // dt_freq
    PyObject * field = PyObject_GetAttrString(_pymsg, "dt_freq");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->dt_freq = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * xsens_msgs__msg__config_xsens__convert_to_py(void * raw_ros_message)
{
  ...
  {  // output_config
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->output_config.data,
      strlen(ros_message->output_config.data),
      "strict");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "output_config", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // sync_config
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "sync_config");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->sync_config.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint32_t * src = &(ros_message->sync_config.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->sync_config.size * sizeof(uint32_t));
      assert(data != NULL);
  ...
  {  // dt_freq
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->dt_freq);
    {
      int rc = PyObject_SetAttrString(_pymessage, "dt_freq", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
