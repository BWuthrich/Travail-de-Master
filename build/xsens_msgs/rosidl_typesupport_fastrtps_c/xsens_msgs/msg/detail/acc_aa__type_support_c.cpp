...
#include "xsens_msgs/msg/detail/acc_aa__rosidl_typesupport_fastrtps_c.h"
...
using _AccAA__ros_msg_type = xsens_msgs__msg__AccAA;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AccAA__ros_msg_type * ros_message = static_cast<const _AccAA__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AccAA__ros_msg_type * ros_message = static_cast<_AccAA__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
size_t get_serialized_size_xsens_msgs__msg__AccAA(
  const void * untyped_ros_message,
...
static uint32_t _AccAA__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xsens_msgs__msg__AccAA(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xsens_msgs
size_t max_serialized_size_xsens_msgs__msg__AccAA(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_xsens_msgs__msg__AccAA(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_AccAA = {
  "xsens_msgs::msg",
  "AccAA",
...
static rosidl_message_type_support_t _AccAA__type_support = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xsens_msgs, msg, AccAA)() {
  return &_AccAA__type_support;
}
