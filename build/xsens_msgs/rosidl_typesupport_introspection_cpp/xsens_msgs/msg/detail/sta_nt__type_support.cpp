...
void StaNT_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) xsens_msgs::msg::StaNT(_init);
}

void StaNT_fini_function(void * message_memory)
{
  auto typed_message = static_cast<xsens_msgs::msg::StaNT *>(message_memory);
  typed_message->~StaNT();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StaNT_message_member_array[1] = {
  {
    ...
    offsetof(xsens_msgs::msg::StaNT, ntrip_status),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StaNT_message_members = {
  ...
  StaNT_fini_function  // function to terminate message instance (will not free memory)
};

static const rosidl_message_type_support_t StaNT_message_type_support_handle = {
  ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  &StaNT_message_members,
...
{
  return &::xsens_msgs::msg::rosidl_typesupport_introspection_cpp::StaNT_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xsens_msgs, msg, StaNT)() {
  return &::xsens_msgs::msg::rosidl_typesupport_introspection_cpp::StaNT_message_type_support_handle;
}
