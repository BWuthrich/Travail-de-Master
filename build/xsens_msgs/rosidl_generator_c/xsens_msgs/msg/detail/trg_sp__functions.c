...
{
  xsens_msgs__msg__TrgSP * msg = (xsens_msgs__msg__TrgSP *)malloc(sizeof(xsens_msgs__msg__TrgSP));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(xsens_msgs__msg__TrgSP));
  bool success = xsens_msgs__msg__TrgSP__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
xsens_msgs__msg__TrgSP__Sequence__init(xsens_msgs__msg__TrgSP__Sequence * array, size_t size)
{
  ...
  xsens_msgs__msg__TrgSP * data = NULL;
  if (size) {
    data = (xsens_msgs__msg__TrgSP *)calloc(size, sizeof(xsens_msgs__msg__TrgSP));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = xsens_msgs__msg__TrgSP__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        xsens_msgs__msg__TrgSP__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
xsens_msgs__msg__TrgSP__Sequence__fini(xsens_msgs__msg__TrgSP__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      xsens_msgs__msg__TrgSP__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  xsens_msgs__msg__TrgSP__Sequence * array = (xsens_msgs__msg__TrgSP__Sequence *)malloc(sizeof(xsens_msgs__msg__TrgSP__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = xsens_msgs__msg__TrgSP__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    xsens_msgs__msg__TrgSP__Sequence__fini(array);
  }
  free(array);
}
