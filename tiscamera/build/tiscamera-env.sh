...
if [ -z "${GST_PLUGIN_PATH_1_0}" ]; then
    export GST_PLUGIN_PATH_1_0="/usr/lib/aarch64-linux-gnu/gstreamer-1.0:${GST_PLUGIN_PATH_1_0}"
else
    export GST_PLUGIN_PATH_1_0="/usr/lib/aarch64-linux-gnu/gstreamer-1.0"
fi
